...
const PeriodicTable = () => {
    ...
    return (
        <div style={{ maxWidth: "90%", overflow: "hidden" }}>
            ...
            <div id="menu">
                <button id="table" onClick={() => onTable()}>TABLE</button>
                <button id="sphere" onClick={() => onSphere()}>SPHERE</button>
                <button id="helix" onClick={() => onHelix()}>HELIX</button>
                <button id="grid" onClick={() => onGrid()}>GRID</button>
            </div>
        </div>
    );
};
