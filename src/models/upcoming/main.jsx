    ...
    function init() {
        ...
        for (let i = 0; i < table.length; i++) {
            ...
            element.addEventListener("hover", function () {
                console.log("The number", element.textContent, "was clicked!");
            });
            // Add hover event listener (optional)
            element.addEventListener("mouseover", function () {
                // Change appearance on hover (optional)
                setLink(table[i][1]);
                setVideo(table[i][2] === "V");
            });
            element.addEventListener("mouseout", function () {
                // Reset appearance after hover (optional)
            });
        ...
        for (let i = 0; i < objects.length; i++) {
            ...
            object.position.y = -Math.floor(i) * 400 + 800;
    ...
    return (
        <div style={{ textAlign: "center" }}>
            ...
            <div id="menu">
                ...
                <button id="table" onClick={() => onTable()}>
                    TABLE
                </button>
                <button id="sphere" onClick={() => onSphere()}>
                    SPHERE
                </button>
                <button id="helix" onClick={() => onHelix()}>
                    HELIX
                </button>
                <p style={{ fontSize: "10px", color: "green" }}> List will be updated soon!</p>
            </div>
        </div>
    );
};
